        ...
        <div className="flex flex-row justify-between items-end border-b border-border-subtle pb-3">
          ...
          {!isUnlocked && (
            <button
              ...
              className="flex items-center gap-1.5 rounded-lg border border-black/[0.05] bg-surface-primary px-3 py-1.5 text-xs font-semibold text-text-primary shadow-sm hover:bg-surface-hover active:scale-95 transition-all"
            >
