                            ...
                            {seedChallengeIndices.map((index) => (
                              <label key={index} className="block">
                                ...
                                <input
                                  ...
                                  className="w-full rounded-xl border border-amber-200 bg-white px-3 py-2 text-sm font-semibold text-text-primary outline-none transition-all focus:border-amber-400 focus:ring-2 focus:ring-amber-200"
                                  autoComplete="off"
                                />
                              </label>
                            ))}
          ...
          <div className="w-full max-w-md rounded-3xl border border-red-200 bg-white/95 p-6 text-left shadow-[0_30px_100px_rgba(127,29,29,0.28)]">
            ...
            <label className="mt-5 block">
              ...
              <input
                ...
                className="w-full rounded-xl border border-red-200 bg-red-50/60 px-3 py-2.5 text-sm font-semibold text-red-950 outline-none transition-all focus:border-red-400 focus:ring-2 focus:ring-red-200"
                autoComplete="off"
              />
            </label>
