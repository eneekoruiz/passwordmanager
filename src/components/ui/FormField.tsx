...
const inputClassName =
  'min-h-11 w-full rounded-xl border border-black/[0.06] bg-white/80 px-3 py-2.5 text-base text-text-primary placeholder:text-text-tertiary shadow-[0_8px_24px_rgba(0,0,0,0.025)] outline-none transition-all duration-150 focus:border-black/15 focus:bg-white focus:ring-2 focus:ring-black/[0.035]'
